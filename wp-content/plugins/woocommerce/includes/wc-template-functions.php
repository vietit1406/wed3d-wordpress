...
function wc_get_gallery_image_html( $attachment_id = null, $main_image = false ,$model3DUrl=null) {
    ...
    if(!empty($model3DUrl)){
        return '<div data-thumb="' . esc_url($model3DUrl[0]) . '" data-thumb-alt="' . esc_attr('3D-MODEL') . '" class="woocommerce-product-gallery__image"><a id="my3DUrl"  data-dir="'. esc_url($model3DUrl['dir']).'" href="' . esc_url($model3DUrl['dir']."/".str_replace('_3ds','',$model3DUrl['name']).'.3ds') . '">' . 'image name' . '</a></div>';
