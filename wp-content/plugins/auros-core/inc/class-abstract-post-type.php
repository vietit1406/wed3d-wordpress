...
abstract class OSF_Custom_Post_Type_Abstract {
    ...
    public function __construct() {
        ...
        $this->link_image = trailingslashit( AUROS_CORE_PLUGIN_URL ) . 'assets/images/customize/';
        $this->options    = array(
    ...
    public function get_icon($name) {
        ...
        if (file_exists( AUROS_CORE_PLUGIN_DIR . '/assets/images/post-type/' . $name . '.png' )){
            return AUROS_CORE_PLUGIN_URL . '/assets/images/post-type/' . $name . '.png';
        } else{
