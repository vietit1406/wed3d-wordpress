...
class OSF_Elementor_Table_Widget extends Widget_Base {
	...
	protected function get_repeater_controls($repeater, $condition = [] ){
		...
		$repeater->add_control('table_icon_selector',
			[
				'label'        => esc_html__('Icon Type','auros-core'),
				'type'         => Controls_Manager::SELECT,
				'default'      => 'font-awesome-icon',
				'options'      =>[
					'font-awesome-icon' => esc_html__('Font Awesome Icon','auros-core'),
					'custom-image'     => esc_html__('Custom Image','auros-core'),
				],
				'condition'     => array_merge( $condition, [] ),
			]
		);
		...
		$repeater->add_control('table_cell_icon_align',
			[
				'label'         => esc_html__('Icon Position', 'auros-core'),
				'type'          => Controls_Manager::SELECT,
				'default'       => 'before',
				'options'       => [
					'top'           => esc_html__('Top', 'auros-core'),
					'before'        => esc_html__('Before', 'auros-core'),
					'after'         => esc_html__('After', 'auros-core'),
				],
				'condition'	=> array_merge( $condition, [] ),
				'label_block'   => true,
			]
		...
		$repeater->add_control('table_cell_icon_spacing',
			[
				'label'         => esc_html__('Icon Spacing', 'auros-core'),
		...
		$repeater->add_control('table_cell_row_span',
			[
				'label'         => esc_html__('Row Span', 'auros-core'),
				'type'          => Controls_Manager::NUMBER,
				'title'         => esc_html__('Enter the number of rows for the cell', 'auros-core'),
				'default'       => 1,
				'min'           => 1,
				'max'           => 10,
				'condition'     => array_merge( $condition, [] ),
		...
		$repeater->add_control('table_cell_span',
			[
				'label'         => esc_html__('Column Span', 'auros-core'),
				'type'          => Controls_Manager::NUMBER,
				'title'         => esc_html__('Enter the number of columns for the cell', 'auros-core'),
				'default'       => 1,
				'min'           => 1,
				'max'           => 10,
				'condition'     => array_merge( $condition, [] ),
		...
		$repeater->add_responsive_control('table_cell_align',
			[
				'label'         => esc_html__( 'Alignment', 'auros-core' ),
				'type'          => Controls_Manager::CHOOSE,
				'options'       => [
					'left'      => [
						'title'=> esc_html__( 'Left', 'auros-core' ),
						'icon' => 'fa fa-align-left',
					],
					'center'    => [
						'title'=> esc_html__( 'Center', 'auros-core' ),
						'icon' => 'fa fa-align-center',
					],
					'right'     => [
						'title'=> esc_html__( 'Right', 'auros-core' ),
	...
	protected function _register_controls(){
		...
		$this->start_controls_section('table_data_section',
			[
				'label'     => esc_html__('Data', 'auros-core'),
			]
		);

		$this->add_control('table_data_type',
			[
				'label'     => esc_html__('Data Type', 'auros-core'),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'custom'    => esc_html__('Custom', 'auros-core'),
					'csv'       => 'CSV' . esc_html__(' File','auros-core')
				],
				'default'   => 'custom'
			]);
		...
		$this->add_control('table_csv_type',
			[
				'label'     => esc_html__('File Type', 'auros-core'),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'file'      => esc_html__('Upload FIle', 'auros-core'),
					'url'       => esc_html__('Remote File','auros-core')
				],
				'condition' => [
					'table_data_type'   => 'csv',
				],
		...
		$this->add_control('table_csv',
			[
				'label'     => esc_html__('Upload CSV File', 'auros-core'),
				'type'      => Controls_Manager::MEDIA,
				'condition' => [
					'table_data_type'   => 'csv',
					'table_csv_type'    => 'file'
		...
		$this->add_control('table_csv_url',
			[
				'label'     => esc_html__('File URL', 'auros-core'),
				'type'      => Controls_Manager::TEXT,
				'label_block'   => true,
				'condition' => [
					'table_data_type'   => 'csv',
		...
		$this->start_controls_section('table_head_section',
			[
				'label'     => esc_html__('Head', 'auros-core'),
				'condition' => [
		...
		$this->add_control('table_head_repeater',
			[
				'label'         => esc_html__('Cell', 'auros-core'),
				'type'          => Controls_Manager::REPEATER,
				'fields'        => $head_repeater->get_controls(),
				'default'       => [
					[
						'table_text'    => esc_html__('First Head', 'auros-core'),
					],
					[
						'table_text'    => esc_html__('Second Head', 'auros-core'),
					],
					[
						'table_text'    => esc_html__('Third Head', 'auros-core'),
					]
				],
		...
		$this->start_controls_section('table_body_section',
			[
				'label'     => esc_html__('Body', 'auros-core'),
				'condition' => [
					'table_data_type'   => 'custom'
				]
			]
		...
		$body_repeater->add_control('table_elem_type',
			[
				'label'     => esc_html__('Type', 'auros-core'),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'cell'      => esc_html__('Cell', 'auros-core'),
					'row'       => esc_html__('Row', 'auros-core'),
				],
				'default'   => 'cell'
			]
		);
		...
		$body_repeater->add_control('table_cell_type',
			[
				'label'     => esc_html__('Cell Type', 'auros-core'),
				'type'      => Controls_Manager::SELECT,
				'options'   => [
					'td'        => esc_html__('Body', 'auros-core'),
					'th'        => esc_html__('Head', 'auros-core'),
				],
				'default'   => 'td',
				'condition'     => [
		...
		$body_repeater->add_control('table_link_selection',
			[
				'label'         => esc_html__('Link Type', 'auros-core'),
				'type'          => Controls_Manager::SELECT,
				'options'       => [
		...
		$this->add_control('table_body_repeater',
			[
				...
				'default' 	=> [
					...
					[
						'table_elem_type' 			=> 'cell',
						'table_text'                => esc_html__( 'Column #1', 'auros-core' ),
					],
					[
						'table_elem_type' 			=> 'cell',
						'table_text'                => esc_html__( 'Column #2', 'auros-core' ),
					],
					[
						'table_elem_type'           => 'cell',
						'table_text'                => esc_html__( 'Column #3', 'auros-core' ),
					],
					[
						'table_elem_type'           => 'row',
					],
		...
		$this->start_controls_section('table_display',
			[
				'label'         => esc_html__('Display Options', 'auros-core'),
			]
		);

		$this->add_responsive_control('table_width',
			[
				'label'         => esc_html__('Width', 'auros-core'),
				'type'          => Controls_Manager::SLIDER,
				'size_units'    => ['px', '%'],
				'range'         => [
					'px'    => [
		...
		$this->add_control('table_responsive',
			[
				'label' 		=> esc_html__( 'Responsive', 'auros-core' ),
				'type' 			=> Controls_Manager::SWITCHER,
				'description'   => esc_html__( 'Enables scroll on mobile.', 'auros-core' ),
		...
		$this->add_responsive_control('table_align',
			[
				'label'         => esc_html__( 'Table Alignment', 'auros-core' ),
				'type'          => Controls_Manager::CHOOSE,
				'options'       => [
					'flex-start'      => [
						'title'=> esc_html__( 'Left', 'auros-core' ),
		...
		$this->start_controls_tab('table_odd_head_odd_style',
			[
				'label'     => esc_html__('Odd', 'auros-core'),
			]
		);
		...
		$this->add_control('table_odd_head_hover_color',
			[
				'label'         => esc_html__('Text Hover Color', 'auros-core'),
				'type'          => Controls_Manager::COLOR,
				'scheme'        => [
					'type'      => Color::get_type(),
					'value'     => Color::COLOR_1,
		...
		$this->add_control('table_odd_head_icon_color',
			[
				'label'         => esc_html__('Icon Color', 'auros-core'),
				'type'          => Controls_Manager::COLOR,
				'scheme'        => [
					'type'      => Color::get_type(),
					'value'     => Color::COLOR_1,
		...
		$this->add_control('table_odd_head_background_popover',
			[
				'label'         => esc_html__('Background', 'auros-core'),
		...
		$this->add_control('table_odd_head_background_heading',
			[
				'label'             => esc_html__('Normal', 'auros-core'),
		...
		$this->add_control('table_odd_head_hover_background_heading',
			[
				'label'             => esc_html__('Hover', 'auros-core'),
				'type'              => Controls_Manager::HEADING
			]);
		...
		$this->start_controls_tab('table_head_even_style',
			[
				'label'     => esc_html__('Even', 'auros-core'),
			]
		);
		...
		$this->start_controls_section('table_row_style',
			[
				'label'         => esc_html__('Rows', 'auros-core'),
				'tab'           => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->start_controls_section('table_col_style',
			[
				'label'         => esc_html__('Columns', 'auros-core'),
				'tab'           => Controls_Manager::TAB_STYLE
			]
		);
		...
		$this->start_controls_section('table_sort_style',
			[
				'label'         => esc_html__('Sort', 'auros-core'),
				'tab'           => Controls_Manager::TAB_STYLE,
				'condition'     => [
					'table_sort'    => 'yes',
					'table_data_type!'  => 'csv'
		...
		$this->add_control('table_sort_color',
			[
				'label'         => esc_html__('Color', 'auros-core'),
				'type'          => Controls_Manager::COLOR,
				'scheme'        => [
					'type'      => Color::get_type(),
					'value'     => Color::COLOR_2,
		...
		$this->add_control('table_sort_hover_color',
			[
				'label'         => esc_html__('Hover Color', 'auros-core'),
				'type'          => Controls_Manager::COLOR,
				'scheme'        => [
					'type'      => Color::get_type(),
					'value'     => Color::COLOR_2,
		...
		$this->start_controls_section('table_search_style',
			[
				'label'         => esc_html__('Search', 'auros-core'),
				'tab'           => Controls_Manager::TAB_STYLE,
				'condition'     => [
					'table_search'    => 'yes'
				]
		...
		$this->start_controls_section('table_style',
			[
				'label'         => esc_html__('Table', 'auros-core'),
				'tab'           => Controls_Manager::TAB_STYLE
			]
		);
