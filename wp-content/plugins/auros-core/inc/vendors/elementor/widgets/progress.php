...
class OSF_Widget_Progress extends Widget_Progress {
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'section_progress',
			[
				'label' => __( 'Progress Bar', 'auros-core' ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'My Skill', 'auros-core' ),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => '',
				'options' => [
					'' => __( 'Default', 'auros-core' ),
					'info' => __( 'Info', 'auros-core' ),
					'success' => __( 'Success', 'auros-core' ),
					'warning' => __( 'Warning', 'auros-core' ),
					'danger' => __( 'Danger', 'auros-core' ),
				],
			]
		);
		...
		$this->add_control(
			'percent',
			[
				'label' => __( 'Percentage', 'auros-core' ),
        ...
        $this->add_control(
            'enable_text_outside',
            [
                'label'     => __('Enable Outside', 'auros-core'),
                'type'      => \Elementor\Controls_Manager::SWITCHER,
                'label_on'  => __('Yes', 'auros-core'),
                'label_off' => __('No', 'auros-core'),
                //                'condition' => [
                //                    'layout' => 'carousel',
                //                ],
            ]
		...
		$this->add_control( 'display_percentage', [
			'label' => __( 'Display Percentage', 'auros-core' ),
			'type' => Controls_Manager::SELECT,
			'default' => 'show',
			'options' => [
				'show' => __( 'Show', 'auros-core' ),
				'hide' => __( 'Hide', 'auros-core' ),
			],
		] );
        ...
        $this->add_control(
            'inner_text',
            [
                'label' => __( 'Inner Text', 'auros-core' ),
                'type' => Controls_Manager::TEXT,
                'placeholder' => __( 'e.g. Web Designer', 'auros-core' ),
                'default' => __( 'Web Designer', 'auros-core' ),
                'label_block' => true,
                'condition' => [
                    'enable_text_outside' => '',
                ],
		...
		$this->add_control(
			'bar_inline_color',
			[
				'label' => __( 'Inner Text Color', 'auros-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->start_controls_section(
			'section_title',
			[
				'label' => __( 'Title Style', 'auros-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
...
$widgets_manager->register_widget_type(new OSF_Widget_Progress());