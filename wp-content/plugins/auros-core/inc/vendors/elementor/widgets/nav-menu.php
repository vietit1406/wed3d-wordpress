...
class OSF_Elementor_Nav_Menu extends Widget_Base {
    ...
    public function get_title() {
        return __('Opal Nav Menu', 'auros-core');
    }
    ...
    protected function _register_controls() {
        ...
        if (!empty($menus)) {
            $this->add_control(
                'menu',
                [
                    'label'        => __('Menu', 'auros-core'),
                    'type'         => Controls_Manager::SELECT,
                    'options'      => $menus,
                    'default'      => array_keys($menus)[0],
                    'save_default' => true,
                    'separator'    => 'after',
                    'description'  => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'auros-core'), admin_url('nav-menus.php')),
                ]
            );
        } else {
            $this->add_control(
                ...
                [
                    ...
                    'raw'             => sprintf(__('<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'auros-core'), admin_url('nav-menus.php?action=edit&menu=0')),
                    'separator'       => 'after',
        ...
        $this->add_control(
            'pointer',
            [
                'label'   => __('Pointer', 'auros-core'),
                'type'    => Controls_Manager::SELECT,
                'default' => 'underline',
                'options' => [
                    'none'        => __('None', 'auros-core'),
                    'underline'   => __('Underline', 'auros-core'),
                    'overline'    => __('Overline', 'auros-core'),
                    'double-line' => __('Double Line', 'auros-core'),
                    'framed'      => __('Framed', 'auros-core'),
                    'background'  => __('Background', 'auros-core'),
                    'text'        => __('Text', 'auros-core'),
                    'dot'         => __('Dot', 'auros-core'),
                ],
            ]
        );
        ...
        $this->add_control(
            'indicator',
            [
                'label'        => __('Submenu Indicator', 'auros-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'classic',
                'options'      => [
                    'none'    => __('None', 'auros-core'),
                    'classic' => __('Classic', 'auros-core'),
                    'chevron' => __('Chevron', 'auros-core'),
                    'angle'   => __('Angle', 'auros-core'),
                    'plus'    => __('Plus', 'auros-core'),
                ],
        ...
        $this->add_responsive_control(
            'subMenusMinWidth',
            [
                'label'   => __('Min width Submenu(px)', 'auros-core'),
        ...
        $this->add_responsive_control(
            'subMenusMaxWidth',
            [
                'label'   => __('Max width Submenu(px)', 'auros-core'),
                'type'    => Controls_Manager::SLIDER,
                'range'   => [
                    'px' => [
                        'min' => 100,
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Mobile Dropdown', 'auros-core'),
        ...
        $this->add_control(
            ...
            [
                'label'   => __('Enable Mobile Menu', 'auros-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'dropdown',
                'options'   => [
                    'dropdown' => __('Dropdown', 'auros-core'),
                    'canvas'   => __('Canvas', 'auros-core'),
                    'popup'    => __('Popup', 'auros-core'),
                ],
                'condition' => [
        ...
        $this->add_control(
            'dropdown',
            [
                'label'        => __('Breakpoint', 'auros-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'tablet',
                'options'      => [
                    'mobile' => __('Mobile (767px >)', 'auros-core'),
                    'tablet' => __('Tablet (1023px >)', 'auros-core'),
                    'destop' => __('Destop', 'auros-core'),
                ],
        ...
        $this->add_control(
            'full_width',
            [
                'label'              => __('Full Width', 'auros-core'),
                'type'               => Controls_Manager::SWITCHER,
                'description'        => __('Stretch the dropdown of the menu to full width.', 'auros-core'),
        ...
        $this->add_responsive_control(
            'width_dropdown',
            [
                'label'      => __('Width Dropdown', 'auros-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => 'aside',
                'options'      => [
                    'aside'  => __('Aside', 'auros-core'),
                    'center' => __('Center', 'auros-core'),
                ],
        ...
        $this->add_control(
            'toggle',
            [
                'label'              => __('Toggle Button', 'auros-core'),
                'type'               => Controls_Manager::SELECT,
                'default'            => 'burger',
                'options'            => [
                    ''       => __('None', 'auros-core'),
                    'burger' => __('Hamburger', 'auros-core'),
                ],
        ...
        $this->add_responsive_control(
            'toggle_align',
            [
                'label'        => __('Toggle Align', 'auros-core'),
                'type'         => Controls_Manager::CHOOSE,
                'default'      => 'left',
                'options'      => [
                    'left'   => [
        ...
        $this->add_control(
            'menu-toggle-title',
            [
                'label'   => __('Title Toggle', 'auros-core'),
                'default' => 'Menu',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .elementor-nav-menu--layout-horizontal.elementor-nav-menu--main .elementor-item',
                'condition' => [
                    'layout' => 'horizontal',
                ],
            ]
        ...
        $this->add_control(
            'color_divider',
            [
                'label'     => __('Divider Color', 'auros-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_3,
        ...
        $this->add_responsive_control(
            'height_divider',
            [
                'label'     => __('Divider Padding', 'auros-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .elementor-nav-menu--layout-horizontal.elementor-nav-menu--main .elementor-item:hover',
                'condition' => [
                    'layout' => 'horizontal',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Pointer Color', 'auros-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Schemes\Color::get_type(),
                    'value' => Schemes\Color::COLOR_4,
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'  => '{{WRAPPER}} .elementor-nav-menu--layout-horizontal.elementor-nav-menu--main .elementor-item.elementor-item-active,{{WRAPPER}} .elementor-nav-menu--layout-horizontal.elementor-nav-menu--main .elementor-nav-menu > li.current-menu-parent > a',
                'condition' => [
                    'layout' => 'horizontal',
                ],
            ]
        ...
        $this->add_control(
            'pointer_width',
            [
                'label'     => __('Pointer Width', 'auros-core'),
                'type'      => Controls_Manager::SLIDER,
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => __('Horizontal Padding', 'auros-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
...
//                'devices'   => [ 'desktop', 'tablet' ],
        ...
        $this->add_responsive_control(
            ...
            [
                'label'     => __('Vertical Padding', 'auros-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'max' => 50,
...
//                ],
        ...
        $this->add_control(
            ...
            [
                'raw'             => __('On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'auros-core'),
                'type'            => Controls_Manager::RAW_HTML,
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .elementor-nav-menu--dropdown a:hover, {{WRAPPER}} .elementor-menu-toggle:hover, 
                    #nav-popup-{{ID}} .elementor-nav-menu--dropdown a:hover, #nav-popup-{{ID}} .elementor-menu-toggle:hover,
        ...
        $this->add_control(
            'setting_icon_tongle',
            [
                'label'     => __('Icon Tongle', 'auros-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'toggle_color_hover',
            [
                'label'     => __('Color Hover', 'auros-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Title Tongle', 'auros-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
