...
class OSF_Elementor_Image_Hotspots_Widget extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section('image_hotspots_image_section',
            [
                'label' => esc_html__('Image', 'auros-core'),
            ]
        );
        ...
        $this->start_controls_section('image_hotspots_icons_settings',
            [
                'label' => esc_html__('Hotspots', 'auros-core'),
            ]
        );
        ...
        $repeater->add_control('image_hotspots_icon_type_switch',
            [
                'label'       => esc_html__('Display On', 'auros-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'font_awesome_icon' => esc_html__('Font Awesome Icon', 'auros-core'),
                    'custom_image'      => esc_html__('Custom Image', 'auros-core'),
                    'text'              => esc_html__('Text', 'auros-core'),
                ],
        ...
        $repeater->add_control('image_hotspots_font_awesome_icon',
            [
                'label'     => esc_html__('Select Icon', 'auros-core'),
        ...
        $repeater->add_control('image_hotspots_custom_image',
            [
                'label'     => esc_html__('Custom Image', 'auros-core'),
                'type'      => Controls_Manager::MEDIA,
                'default'   => [
                    'url' => Utils::get_placeholder_image_src(),
                ],
        ...
        $repeater->add_control('image_hotspots_text',
            [
                'label'     => esc_html__('Text', 'auros-core'),
        ...
        $repeater->add_responsive_control('preimum_image_hotspots_main_icons_horizontal_position',
            [
                'label'      => esc_html__('Horizontal Position', 'auros-core'),
        ...
        $repeater->add_responsive_control('preimum_image_hotspots_main_icons_vertical_position',
            [
                'label'      => esc_html__('Vertical Position', 'auros-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'range'      => [
                    'px' => [
        ...
        if (osf_is_woocommerce_activated()) {
            $repeater->add_control('image_hotspots_content',
                [
                    'label'   => esc_html__('Content to Show', 'auros-core'),
                    'type'    => Controls_Manager::SELECT,
                    'options' => [
                        'text_editor'         => esc_html__('Text Editor', 'auros-core'),
                        'elementor_templates' => esc_html__('Elementor Template', 'auros-core'),
                        'elementor_product'   => esc_html__('Product', 'auros-core'),
                    ],
                    'default' => 'text_editor'
                ]
            );
        ...
        $repeater->add_control('image_hotspots_tooltips_temp',
            [
                'label'     => esc_html__('Teamplate ID', 'auros-core'),
        ...
        $repeater->add_control('image_hotspots_tooltips_product',
            [
                'label'     => __('Product id', 'auros-core'),
        ...
        $repeater->add_control('image_hotspots_link_switcher',
            [
                'label'       => esc_html__('Link', 'auros-core'),
                'type'        => Controls_Manager::SWITCHER,
                'description' => esc_html__('Add a custom link or select an existing page link', 'auros-core'),
            ]);

        $repeater->add_control('image_hotspots_link_type',
            [
                'label'       => esc_html__('Link/URL', 'auros-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'url'  => esc_html__('URL', 'auros-core'),
                    'link' => esc_html__('Existing Page', 'auros-core'),
                ],
                'default'     => 'url',
                'condition'   => [
...
//			] );
        ...
        $repeater->add_control('image_hotspots_url',
            [
                'label'       => esc_html__('URL', 'auros-core'),
        ...
        $repeater->add_control('image_hotspots_link_text',
            [
                'label'       => esc_html__('Link Title', 'auros-core'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => ['active' => true],
                'condition'   => [
                    'image_hotspots_link_switcher' => 'yes',
        ...
        $this->add_control('image_hotspots_icons_animation',
            [
                'label' => esc_html__('Radar Animation', 'auros-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section('image_hotspots_tooltips_section',
            [
                'label' => esc_html__('Tooltips', 'auros-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Trigger', 'auros-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'click' => esc_html__('Click', 'auros-core'),
                    'hover' => esc_html__('Hover', 'auros-core'),
                ],
                'default' => 'hover'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Show Arrow', 'auros-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'auros-core'),
                'label_off' => esc_html__('Hide', 'auros-core'),
            ]
        );
        ...
        $this->add_control('image_hotspots_tooltips_distance_position',
            [
                'label'   => esc_html__('Spacing', 'auros-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('The distance between the origin and the tooltip in pixels, default is 6', 'auros-core'),
                'default' => 6,
            ]
        );
        ...
        $this->add_control('image_hotspots_min_width',
            [
                'label'       => esc_html__('Min Width', 'auros-core'),
                'type'        => Controls_Manager::SLIDER,
                'range'       => [
                    'px' => [
                        'min' => 0,
                ...
                'description' => esc_html__('Set a minimum width for the tooltip in pixels, default: 0 (auto width)', 'auros-core'),
            ]
        );

        $this->add_control('image_hotspots_max_width',
            [
                'label'       => esc_html__('Max Width', 'auros-core'),
                'type'        => Controls_Manager::SLIDER,
                'range'       => [
                    'px' => [
                        'min' => 0,
                ...
                'description' => esc_html__('Set a maximum width for the tooltip in pixels, default: null (no max width)', 'auros-core'),
            ]
        );

        $this->add_responsive_control('image_hotspots_tooltips_wrapper_height',
            [
                'label'       => esc_html__('Height', 'auros-core'),
                'type'        => Controls_Manager::SLIDER,
                'size_units'  => ['px', 'em', '%'],
                'range'       => [
                    'px' => [
        ...
        $this->add_control('image_hotspots_anim',
            [
                'label'       => esc_html__('Animation', 'auros-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'fade'  => esc_html__('Fade', 'auros-core'),
                    'grow'  => esc_html__('Grow', 'auros-core'),
                    'swing' => esc_html__('Swing', 'auros-core'),
                    'slide' => esc_html__('Slide', 'auros-core'),
                    'fall'  => esc_html__('Fall', 'auros-core'),
                ],
                'default'     => 'fade',
                'label_block' => true,
            ]
        ...
        $this->add_control('image_hotspots_anim_dur',
            [
                'label'   => esc_html__('Animation Duration', 'auros-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('Set the animation duration in milliseconds, default is 350', 'auros-core'),
                'default' => 350,
            ]
        );
        ...
        $this->add_control('image_hotspots_delay',
            [
                'label'   => esc_html__('Delay', 'auros-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('Set the animation delay in milliseconds, default is 10', 'auros-core'),
                'default' => 10,
            ]
        );
        ...
        $this->add_control('image_hotspots_hide',
            [
                'label'        => esc_html__('Hide on Mobiles', 'auros-core'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => 'Show',
                'label_off'    => 'Hide',
                'description'  => esc_html__('Hide tooltips on mobile phones', 'auros-core'),
                'return_value' => true,
            ]
        );
        ...
        $this->add_control('image_hotspots_image_border_radius',
            [
                'label'      => esc_html__('Border Radius', 'auros-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->add_responsive_control('image_hotspots_image_padding',
            [
                'label'      => esc_html__('Padding', 'auros-core'),
        ...
        $this->start_controls_tab('image_hotspots_main_icons_style_tab',
            [
                'label' => esc_html__('Icon', 'auros-core'),
            ]
        );
        ...
        $this->add_responsive_control('preimum_image_hotspots_main_icons_size',
            [
                'label'      => esc_html__('Size', 'auros-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em'],
                'range'      => [
                    'px' => [
        ...
        $this->add_group_control(
            ...
            [
                'label'    => esc_html__('Shadow', 'auros-core'),
        ...
        $this->add_responsive_control('image_hotspots_main_icons_margin',
            [
                'label'      => esc_html__('Margin', 'auros-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Text Color', 'auros-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Color::get_type(),
                    'value' => Color::COLOR_2,
        ...
        $this->add_control('image_hotspots_radar_background',
            [
                'label'     => __('Radar Background Color', 'auros-core'),
                'type'      => Controls_Manager::COLOR,
                'scheme'    => [
                    'type'  => Color::get_type(),
                    'value' => Color::COLOR_1,
        ...
        $this->add_control('image_hotspots_radar_border_radius',
            [
                'label'      => esc_html__('Radar Border Radius', 'auros-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'condition'  => [
                    'image_hotspots_icons_animation' => 'yes'
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Hotspots Opacity', 'auros-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min'  => 0,
        ...
        $this->add_control('image_hotspots_tooltips_wrapper_background_color',
            [
                'label'     => esc_html__('Background Color', 'auros-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
...
//        );
        ...
        $this->start_controls_section('img_hotspots_container_style',
            [
                'label' => esc_html__('Container', 'auros-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control('img_hotspots_container_padding',
            [
                'label'      => esc_html__('Paddding', 'auros-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
