...
class OSF_Elementor_Image_Layers_Widget extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->start_controls_section('img_layers_content',
            [
                'label' => esc_html__('Images', 'auros-core'),
            ]
        );
        ...
        $repeater->add_control('layers_select',
            [
                'label' => esc_html__('Select Content', 'auros-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'image' => esc_html__('Image Content', 'auros-core'),
                    'text' => esc_html__('Text Content', 'auros-core'),
                ],
                'default' => 'image'
            ]
        );
        ...
        $repeater->add_control('img_layers_image',
            [
                'label' => esc_html__('Upload Image', 'auros-core'),
        ...
        $repeater->add_control('img_layers_alt',
            [
                'label' => esc_html__('Alt', 'auros-core'),
        ...
        $repeater->add_control('text_layers',
            [
                'label' => esc_html__('Content', 'auros-core'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __('Lorem ipsum dolor sit amet', 'auros-core'),
                'condition' => [
                    'layers_select' => 'text'
                ]
            ]
        ...
        $repeater->add_control('img_layers_position',
            [
                'label' => esc_html__('Position', 'auros-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'relative' => esc_html__('Relative', 'auros-core'),
                    'absolute' => esc_html__('Absolute', 'auros-core'),
                ],
                'default' => 'relative'
            ]
        );
        ...
        $repeater->add_responsive_control('img_layers_hor_position',
            [
                'label' => esc_html__('Horizontal Offset', 'auros-core'),
                'type' => Controls_Manager::SLIDER,
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'auros-core'),
                'size_units' => ['px', "em", '%'],
                'range' => [
                    'px' => [
                        'min' => -200,
        ...
        $repeater->add_responsive_control('img_layers_ver_position',
            [
                'label' => esc_html__('Vertical Offset', 'auros-core'),
                'description' => esc_html__('Mousemove Interactivity works only with pixels', 'auros-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', "em", '%'],
                'range' => [
        ...
        $repeater->add_control('img_layers_rotate',
            [
                'label' => esc_html__('Rotate', 'auros-core'),
                'type' => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $repeater->add_control('img_layers_rotatex',
            [
                'label' => esc_html__('Degrees', 'auros-core'),
                'type' => Controls_Manager::NUMBER,
                'description' => esc_html__('Set rotation value in degress', 'auros-core'),
                'min' => -180,
                'max' => 180,
                'condition' => [
        ...
        $repeater->add_control('img_layers_animation',
            [
                'label' => esc_html__('Entrance Animation', 'auros-core'),
        ...
        $repeater->add_control('img_layers_animation_duration',
            [
                ...
                'default' => '',
                'options' => [
                    'slow' => __('Slow', 'auros-core'),
                    '' => __('Normal', 'auros-core'),
                    'fast' => __('Fast', 'auros-core'),
                ],
                'condition' => [
                    'img_layers_animation_switcher' => 'yes',
        ...
        $repeater->add_control('img_layers_animation_delay',
            [
                'label' => esc_html__('Animation Delay', 'auros-core') . ' (s)',
                'type' => Controls_Manager::NUMBER,
                'default' => '',
                'min' => 0,
                'step' => 0.1,
        ...
        $repeater->add_control('img_layers_mouse',
            [
                'label' => esc_html__('Mousemove Interactivity', 'auros-core'),
                'type' => Controls_Manager::SWITCHER,
                'description' => esc_html__('Enable or disable mousemove interaction', 'auros-core'),
            ]
        );

        $repeater->add_control('img_layers_mouse_type',
            [
                'label' => esc_html__('Interactivity Style', 'auros-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'parallax' => esc_html__('Mouse Parallax', 'auros-core'),
                    'tilt' => esc_html__('Tilt', 'auros-core'),
                ],
                'default' => 'parallax',
                'label_block' => true,
                'condition' => [
        ...
        $repeater->add_control('img_layers_rate',
            [
                'label' => esc_html__('Rate', 'auros-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => -10,
                'min' => -20,
                'max' => 20,
                'step' => 1,
                'description' => esc_html__('Choose the movement rate for the layer image, default: -10', 'auros-core'),
                'separator' => 'after',
                'label_block' => true,
                'condition' => [
                    'img_layers_mouse' => 'yes',
        ...
        $repeater->add_control('img_layers_zindex',
            [
                'label' => esc_html__('z-index', 'auros-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => 1,
                'selectors' => [
        ...
        $repeater->add_control('img_layers_class',
            [
                'label' => esc_html__('CSS Classes', 'auros-core'),
                'type' => Controls_Manager::TEXT,
                'description' => esc_html__('Separate class with spaces', 'auros-core'),
            ]
        );
...
$widgets_manager->register_widget_type(new OSF_Elementor_Image_Layers_Widget());