...
class OSF_Elementor_Header_Group extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Header Group', 'auros-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'show_wishlist',
            [
                'label' => __('Show wishlist', 'auros-core'),
        ...
        $this->add_control(
            'show_search',
            [
                'label' => __('Show search form', 'auros-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_account',
            [
                'label' => __('Show account', 'auros-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section(
            'wishlist_config',
            [
                'label'     => __('WooCommerce Wishlist', 'auros-core'),
                'condition' => [
                    'show_wishlist!' => '',
                ],
            ]
        ...
        $this->add_control(
            'show_subtotal',
            [
                'label' => __('Show Total', 'auros-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __('View wishlist ', 'auros-core'),
                'label_block' => true,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Wishlist Style', 'auros-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Background Hover Color', 'auros-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'section_input_style',
            [
                'label'     => __('Search Form Style', 'auros-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_search!' => '',
                ],
        ...
        $this->add_control(
            'button_border_width',
            [
                'label'     => __('Border Size', 'auros-core'),
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Account Style', 'auros-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_account' => 'yes',
                ],
        ...
        $this->start_controls_section(
            'section_lable_style',
            [
                'label'     => __('Cart Style', 'auros-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_cart' => 'yes',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Title Hover Color', 'auros-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
    ...
    protected function render_cart() {
        ...
        <div class="site-header-cart menu d-flex <?php echo esc_attr($settings['cart_align']); ?>">
            <a data-toggle="toggle" class="cart-contents header-button d-flex align-items-center" href="<?php echo esc_url(wc_get_cart_url()); ?>" title="">
