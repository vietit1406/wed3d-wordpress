...
class OSF_Elementor_Heading extends Widget_Heading
{
    ...
    {
        return __('Opal Heading', 'auros-core');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Add Your Heading Text Here', 'auros-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'small' => __('Small', 'auros-core'),
                    'medium' => __('Medium', 'auros-core'),
                    'large' => __('Large', 'auros-core'),
                    'xl' => __('XL', 'auros-core'),
                    'xxl' => __('XXL', 'auros-core'),
                ],
            ]
        );
        ...
        $this->add_control(
            'title_color_style',
            [
                'label' => __('Color Gradient', 'auros-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Color Secondary', 'auros-core'),
                'type' => Controls_Manager::COLOR,
                'scheme' => [
                    'type' => Color::get_type(),
                    'value' => Color::COLOR_1,
