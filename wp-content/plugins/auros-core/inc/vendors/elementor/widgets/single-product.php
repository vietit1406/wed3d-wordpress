...
class OSF_Elementor_Single_Product extends Elementor\Widget_Base
{
    ...
    {
        return __('Opal Single Product', 'auros-core');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'show_title',
            [
                'label' => __('Hide Title', 'auros-core'),
        ...
        $this->add_control(
            'show_rating',
            [
                'label' => __('Hide Rating', 'auros-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'return_value' => 'none',
                'selectors' => [
        ...
        $this->add_control(
            'show_price',
            [
                'label' => __('Hide Price', 'auros-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'return_value' => 'none',
                'selectors' => [
        ...
        $this->add_control(
            'show_description',
            [
                'label' => __('Hide Description', 'auros-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'return_value' => 'none',
                'selectors' => [
        ...
        $this->add_control(
            'show_quantity',
            [
                'label' => __('Hide Quantity', 'auros-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
                'return_value' => 'none',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .single-product div.product form.cart .quantity label, {{WRAPPER}} .single-product div.product form.cart .quantity input, {{WRAPPER}} .single-product div.product .woocommerce-product-rating .reviews-count,{{WRAPPER}} label, {{WRAPPER}} p,{{WRAPPER}} .opal-woocommerce-deal .countdown-times' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .single-product div.product .summary .price del' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'price_color',
            [
                'label' => __('Price Color', 'auros-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
    ...
    private function add_hook()
    {
        ...
        add_action('woocommerce_single_product_summary', 'osf_woocommerce_single_deal', 19);
