...
class OSF_Elementor_Rotate_Image extends Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Rotate Image', 'auros-core' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => __( 'Rotate Image', 'auros-core' ),
			]
		);
		...
		$this->add_control(
			'carousel',
			[
				'label' => __( 'Add Images', 'auros-core' ),
...
$widgets_manager->register_widget_type(new OSF_Elementor_Rotate_Image());