...
class OSF_Elementor_Counter extends Widget_Counter
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'starting_number',
            [
                'label' => __('Starting Number', 'auros-core'),
        ...
        $this->add_control(
            'ending_number',
            [
                'label' => __('Ending Number', 'auros-core'),
                'type' => Controls_Manager::NUMBER,
                'default' => 100,
            ]
        );
        ...
        $this->add_control(
            'prefix',
            [
                'label' => __('Number Prefix', 'auros-core'),
        ...
        $this->add_control(
            'suffix',
            [
                'label' => __('Number Suffix', 'auros-core'),
                'type' => Controls_Manager::TEXT,
                'default' => '',
                'placeholder' => __('Plus', 'auros-core'),
            ]
        );
        ...
        $this->add_control(
            'icon_select',
            [
                'label' => __('Icon select', 'auros-core'),
                'type' => Controls_Manager::SELECT,
                'default' => 'use_icon',
                'options' => [
                    'use_icon' => __('Use Icon', 'auros-core'),
                    'use_image' => __('Use Image', 'auros-core'),
                ],
                'condition' => [
                    'show_icon' => 'yes',
                ],
        ...
        $this->add_control(
            'thousand_separator',
            [
                'label' => __('Thousand Separator', 'auros-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'label_on' => __('Show', 'auros-core'),
                'label_off' => __('Hide', 'auros-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => __('Cool Number', 'auros-core'),
                'placeholder' => __('Cool Number', 'auros-core'),
            ]
        );
