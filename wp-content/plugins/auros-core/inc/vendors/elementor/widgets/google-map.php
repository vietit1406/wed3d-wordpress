...
class OSF_Elementor_Google_Map extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Google Maps', 'auros-core' );
    }
    ...
    public function get_script_depends() {
        $api_key = osf_get_option('opal-settings', 'api_key', 'AIzaSyDRVUZdOrZ1HuJFaFkDtmby0E93eJLykIk');
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'latitude',
            array(
                'label'   => __('Latitude', 'auros-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '21.030497',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'auros-core' ), 'https://www.google.com/maps')
            )
        ...
        $this->add_control(
            'longitude',
            array(
                'label'   => __('Longitude', 'auros-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => '105.852510',
                'description' => sprintf( __( 'The latitude and longitude to center the map. Ex: 21.030497, 105.852510. Please go to <a href="%s" target="_blank">Google maps</a>. to find your location and get latitude and longitude.', 'auros-core' ), 'https://www.google.com/maps')
            )
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => [ 'size' => 500 ],
                'description' => esc_html__( 'Height of map.(px)', 'auros-core' ),
                'selectors' => [
        ...
        $this->add_control(
            'zoom',
            [
                'label' => __( 'Zoom Level', 'auros-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 10,
                ],
        ...
        $this->add_control(
            'prevent_scroll',
            [
                'label' => __( 'Prevent Scroll', 'auros-core' ),
        ...
        $this->add_control(
            'style',
            [
                'label' => __('Select Style', 'auros-core'),
        ...
        $this->add_control(
            'water_color',
            [
                'label' => __( 'Water Color', 'auros-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => \Elementor\Core\Schemes\Color::get_type(),
        ...
        $this->add_control(
            'water_lightness',
            [
                'label' => __( 'Water Lightness', 'auros-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            'landscape_color',
            [
                'label' => __( 'Landscape Color', 'auros-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => \Elementor\Core\Schemes\Color::get_type(),
        ...
        $this->add_control(
            'landscape_lightness',
            [
                'label' => __( 'Landscape Lightness', 'auros-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 15,
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Color', 'auros-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => \Elementor\Core\Schemes\Color::get_type(),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Administrative Lightness', 'auros-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'poi_lightness',
            [
                'label' => __( 'Poi Lightness', 'auros-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'road_color',
            [
                'label' => __( 'Road Color', 'auros-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => \Elementor\Core\Schemes\Color::get_type(),
        ...
        $this->add_control(
            'road_lightness',
            [
                'label' => __( 'Road Lightness', 'auros-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
        ...
        $this->add_control(
            'transit_color',
            [
                'label' => __( 'Transit Color', 'auros-core' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'scheme' => [
                    'type' => \Elementor\Core\Schemes\Color::get_type(),
        ...
        $this->add_control(
            'transit_lightness',
            [
                'label' => __( 'Transit Lightness', 'auros-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 17,
                ],
    ...
    private function data_style_title(){
        return array(
            ...
            'ultra_light' => __('Ultra Light', 'auros-core'),
            'shades_of_grey' => __('Shades of Grey', 'auros-core'),
            'blue_water' => __('Blue Water', 'auros-core'),
            'light_grey_and_blue' => __('Light Grey and Blue', 'auros-core'),
            'farma_gray' => __('Farma Gray', 'auros-core'),
            'community' => __('Community', 'auros-core'),
            'chilled' => __('Chilled', 'auros-core'),
            'customize' => __('Customize', 'auros-core')
