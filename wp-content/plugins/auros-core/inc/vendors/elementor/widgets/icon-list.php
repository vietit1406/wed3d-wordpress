...
class OSF_Widget_Icon_List extends Widget_Icon_List {
	...
	public function get_title() {
		return __( 'Opal Icon List', 'auros-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'traditional' => [
						'title' => __( 'Default', 'auros-core' ),
						'icon' => 'eicon-editor-list-ul',
					],
					'inline' => [
						'title' => __( 'Inline', 'auros-core' ),
		...
		$repeater->add_control(
			...
			[
				...
				'label_block' => true,
				'placeholder' => __( 'List Item', 'auros-core' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'text' => __( 'List Item #1', 'auros-core' ),
						'icon' => 'fa fa-check',
					],
					[
						'text' => __( 'List Item #2', 'auros-core' ),
						'icon' => 'fa fa-times',
					],
					[
						'text' => __( 'List Item #3', 'auros-core' ),
		...
		$this->add_control(
			'text_indent',
			[
				'label' => __( 'Text Indent', 'auros-core' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
