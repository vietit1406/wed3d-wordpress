...
class OSF_Widget_Image_Box extends Widget_Image_Box {
    ...
    public function get_title() {
        return __('Image Box', 'auros-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'placeholder' => __('Enter your sub-title', 'auros-core'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'position',
            [
                'label'        => __('Image Position', 'auros-core'),
        ...
        $this->add_control(
            'view_bg',
            [
                'label'     => __('Box View Background', 'auros-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'title_color_hover',
            [
                'label'     => __('Color Hover (Wrapper)', 'auros-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
