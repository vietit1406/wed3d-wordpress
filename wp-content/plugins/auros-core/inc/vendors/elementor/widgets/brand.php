...
class OSF_Elementor_Brand extends  OSF_Elementor_Carousel_Base{
    ...
    public function get_title() {
        return __( 'Opal Brands', 'auros-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'brands',
            [
                'label' => __( 'Brand Items', 'auros-core' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => [
                    [
                        'name' => 'brand_title',
                        'label' => __( 'Brand name', 'auros-core' ),
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Brand Name', 'auros-core' ),
                        'placeholder' => __( 'Brand Name', 'auros-core' ),
                        'label_block' => true,
                    ],
                    [
                        'name' => 'brand_image',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Carousel Options', 'auros-core' ),
        ...
        $this->add_control(
            'navigation',
            [
                'label' => __( 'Navigation', 'auros-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'both',
                'options' => [
                    'both' => __( 'Arrows and Dots', 'auros-core' ),
                    'arrows' => __( 'Arrows', 'auros-core' ),
                    'dots' => __( 'Dots', 'auros-core' ),
        ...
        $this->add_control(
            'pause_on_hover',
            [
                'label' => __( 'Pause on Hover', 'auros-core' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label' => __( 'Autoplay Speed', 'auros-core' ),
        ...
        $this->add_control(
            'infinite',
            [
                'label' => __( 'Infinite Loop', 'auros-core' ),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
