...
class OSF_Elementor_Button_Contact_Form extends  Widget_Button {
    ...
    public function get_title() {
        return __('Opal Button Contact Form 7', 'auros-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Request A Call Back', 'auros-core' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Free consultation', 'auros-core' ),
                'separator' => 'before',
            ]
        );
...
$widgets_manager->register_widget_type(new OSF_Elementor_Button_Contact_Form());