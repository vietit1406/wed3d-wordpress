...
class OSF_Element_Site_Logo extends Widget_Image {
    ...
    public function get_title() {
        return __( 'Opal Site Logo', 'auros-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_extra',
            [
                'label' => __( 'Logo Site', 'auros-core' ),
            ]
        );
        $this->add_control(
            'logo_select',
            [
                'label' => __( 'Image from', 'auros-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'site_logo',
                'options' => [
                    'site_logo' => __( 'Use Site Logo', 'auros-core' ),
                    'customize' => __( 'Custom Logo', 'auros-core' ),
                ]
            ]
        );
