...
class OSF_Element_Social_Share extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Social Share', 'auros-core' );
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Share Buttons', 'auros-core' ),
            ]
        );
        ...
        $this->add_control(
            'socials',
            [
                'label' => __( 'Select Socials', 'auros-core' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'gradient' => __( 'Gradient', 'auros-core' ),
                    'minimal' => __( 'Minimal', 'auros-core' ),
                    'framed' => __( 'Framed', 'auros-core' ),
                    'boxed' => __( 'Boxed Icon', 'auros-core' ),
                    'flat' => __( 'Flat', 'auros-core' ),
                ],
                'default' => 'gradient',
        ...
        $this->add_responsive_control(
            'column_gap',
            [
                'label'     => __( 'Columns Gap', 'auros-core' ),
        ...
        $this->add_responsive_control(
            'button_size',
            [
                'label' => __( 'Button Size', 'auros-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0.5,
        ...
        $this->add_responsive_control(
            'button_height',
            [
                'label' => __( 'Button Height', 'auros-core' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'em' => [
                        'min' => 1,
            ...
            <?php foreach ( $settings['socials'] as $button ) {
                ...
                <div class="elementor-grid-item">
                    <div class="elementor-share-btn">
                        <a href="<?php $this->render_html_social($button); ?>" target="_blank" title="<?php printf( __('Share on %s', 'auros-core'), $title)?>">
    ...
    public function render_html_social($key){
        ...
        switch ($key){
            case 'facebook':
                echo $ssl.'facebook.com/sharer.php?display=page&u='. get_the_permalink();
                break;
