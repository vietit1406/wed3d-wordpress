...
class OSF_Elementor_Price_Table extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Price Table', 'auros-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Pricing Table', 'auros-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __('I am subtitle', 'auros-core'),
            ]
        );
        ...
        $this->add_control(
            'currency_symbol',
            [
                'label' => __('Currency Symbol', 'auros-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => __('None', 'auros-core'),
                    'dollar' => '&#36; ' . _x('Dollar', 'Currency Symbol', 'auros-core'),
                    'euro' => '&#128; ' . _x('Euro', 'Currency Symbol', 'auros-core'),
                    'baht' => '&#3647; ' . _x('Baht', 'Currency Symbol', 'auros-core'),
                    'franc' => '&#8355; ' . _x('Franc', 'Currency Symbol', 'auros-core'),
                    'guilder' => '&fnof; ' . _x('Guilder', 'Currency Symbol', 'auros-core'),
                    'krona' => 'kr ' . _x('Krona', 'Currency Symbol', 'auros-core'),
                    'lira' => '&#8356; ' . _x('Lira', 'Currency Symbol', 'auros-core'),
                    'peseta' => '&#8359 ' . _x('Peseta', 'Currency Symbol', 'auros-core'),
                    'peso' => '&#8369; ' . _x('Peso', 'Currency Symbol', 'auros-core'),
                    'pound' => '&#163; ' . _x('Pound Sterling', 'Currency Symbol', 'auros-core'),
                    'real' => 'R$ ' . _x('Real', 'Currency Symbol', 'auros-core'),
                    'ruble' => '&#8381; ' . _x('Ruble', 'Currency Symbol', 'auros-core'),
                    'rupee' => '&#8360; ' . _x('Rupee', 'Currency Symbol', 'auros-core'),
                    'indian_rupee' => '&#8377; ' . _x('Rupee (Indian)', 'Currency Symbol', 'auros-core'),
                    'shekel' => '&#8362; ' . _x('Shekel', 'Currency Symbol', 'auros-core'),
                    'yen' => '&#165; ' . _x('Yen/Yuan', 'Currency Symbol', 'auros-core'),
                    'won' => '&#8361; ' . _x('Won', 'Currency Symbol', 'auros-core'),
                    'custom' => __('Custom', 'auros-core'),
                ],
                'default' => 'dollar',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Custom Symbol', 'auros-core'),
                'type' => Controls_Manager::TEXT,
                'condition' => [
        ...
        $this->add_control(
            'currency_format',
            [
                'label' => __('Currency Format', 'auros-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => '1,234.56 (Default)',
                    ',' => '1.234,56',
        ...
        $this->add_control(
            'original_price',
            [
                'label' => __('Original Price', 'auros-core'),
        ...
        $this->add_control(
            'period',
            [
                'label' => __('Period', 'auros-core'),
                'type' => Controls_Manager::TEXT,
                'default' => __('Monthly', 'auros-core'),
            ]
        );
        ...
        $this->add_control(
            'sub_period',
            [
                'label' => __('Sub Period', 'auros-core'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __('Sub Period...', 'auros-core'),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'default' => __('List Item', 'auros-core'),
            ]
        );
        ...
        $repeater->add_control(
            'item_icon_color',
            [
                'label' => __('Icon Color', 'auros-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'item_text' => __('List Item #1', 'auros-core'),
                        'item_icon' => 'fa fa-check-circle',
                    ],
                    [
                        'item_text' => __('List Item #2', 'auros-core'),
                        'item_icon' => 'fa fa-check-circle',
                    ],
                    [
                        'item_text' => __('List Item #3', 'auros-core'),
                        'item_icon' => 'fa fa-check-circle',
                    ],
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __('Additional Info', 'auros-core'),
                'type' => Controls_Manager::TEXTAREA,
                'default' => __('This is text element', 'auros-core'),
                'rows' => 2,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __('Fractional Part', 'auros-core'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'solid' => __('Solid', 'auros-core'),
                    'double' => __('Double', 'auros-core'),
                    'dotted' => __('Dotted', 'auros-core'),
                    'dashed' => __('Dashed', 'auros-core'),
                ],
                'default' => 'solid',
                'condition' => [
                    'list_divider' => 'yes',
        ...
        $this->add_control(
            'button_text_padding',
            [
                'label' => __('Text Padding', 'auros-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
