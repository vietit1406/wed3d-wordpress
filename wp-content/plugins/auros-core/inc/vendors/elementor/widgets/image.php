...
class OSF_Elementor_Image extends Widget_Image {
    ...
    public function get_title() {
        return __( 'Opal Image', 'auros-core' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'caption',
            [
                'label' => __( 'Caption', 'auros-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => '',
                'placeholder' => __( 'Enter your image caption', 'auros-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'file' => __( 'Media File', 'auros-core' ),
                    'custom' => __( 'Custom URL', 'auros-core' ),
                ],
            ]
        );
        ...
        $this->add_control(
            'open_lightbox',
            [
                'label' => __( 'Lightbox', 'auros-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => __( 'Default', 'auros-core' ),
                    'yes' => __( 'Yes', 'auros-core' ),
                    'no' => __( 'No', 'auros-core' ),
                ],
                'condition' => [
                    'link_to' => 'file',
        ...
        $this->add_control(
            'spin',
            [
                'label' => __('Spin', 'auros-core'),
                'type'  => Controls_Manager::SWITCHER,
                'label_on'  => __('On', 'auros-core'),
                'label_of'  => __('Off', 'auros-core'),
...
$widgets_manager->register_widget_type(new OSF_Elementor_Image());
