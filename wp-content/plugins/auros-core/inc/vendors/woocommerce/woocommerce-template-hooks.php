...
//Social
add_action('woocommerce_single_product_summary', 'osf_single_product_social', 50);
...
function osf_include_hooks_product_blocks() {
    ...
    switch ($product_style) {
        ...
        case 5:
            ...
            add_action('woocommerce_before_shop_loop_item_title', 'woocommerce_template_loop_add_to_cart', 60);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_product_loop_caption_start', 0);
            add_action('woocommerce_shop_loop_item_title', 'osf_woocommerce_get_product_category', 0);
            add_action('woocommerce_after_shop_loop_item_title', 'osf_woocommerce_product_loop_caption_end', 99);
